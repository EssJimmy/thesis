...
def get_depth_stream_model(model_name: str = "/home/jimmy/Documents/thesis/realsense/yolo/yolo11n-seg.pt") -> None:
            ...
            if realsense_results[0].boxes.id is not None and realsense_results[0].masks is not None:
                ...
                if distance_mm < 850:
                    ...
                    depth_request = d_pb2.DepthRequest(
                        depth_values=float(distance_mm),
                        x_coord=int(x),
                        y_coord=int(y)
                    )
